...
\acmConference[EDBT '26]{EDBT}{2026}{Finland}
%%%
...
\newcommand{\tabcaption}[1]{\vspace*{0mm}\caption{#1}\vspace*{-6mm}}
\newcommand{\figcaption}[1]{\vspace*{-3mm}\caption{#1}\vspace*{-4mm}}

\newcommand{\figwidth}{0.80\columnwidth}
...
We have not used any artifacts.  All figures and tables are created by us.
