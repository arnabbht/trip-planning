...
gives an utility of $0$.  Each POI is also marked with a type (e.g.,
...
the same type may be included and/or at least one POI of a particular
type must be included, etc.  She may also put in ordering
...
\begin{table}[t]
	...
	\resizebox{0.85\columnwidth}{!}
	{
		\begin{tabular}{c l rrr}
			\toprule
			\textbf{ID} & \textbf{Type} & \textbf{Visit Time} & \textbf{Utility} & \textbf{Visit Cost} \\
			\midrule
			%S & Source      & 0  & 0   & 0    \\
			1 & Park        & 90 & 886 & 1320 \\
			2 & Park        & 30 & 253 & 440  \\
...
Further, she must visit at least 2 POIs of the type Park, and will not visit more than 2 POIs of the type Museum.

Respecting all these constraints, the optimal itinerary is $[S, 3, 5, 2,
1, D]$, as shown in Figure~\ref{fig:example_graph}.  The total utility
obtained from the itinerary is 1738 units, and the time and cost spent
in the itinerary are, respectively, 3211 ($<$3500) and 256.75 ($<$300)
units.
